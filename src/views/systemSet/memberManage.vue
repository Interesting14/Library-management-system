<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input @keyup.enter.native="handleFilter" style="width: 200px;" class="filter-item" placeholder="会员编号" v-model="listQuery.title">
      </el-input>

     

      <el-select clearable class="filter-item" style="width: 130px" v-model="listQuery.type" placeholder="会员等级">
    ...
    <el-table ref="multipleTable" @selection-change="handleSelectionChange" :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit highlight-current-row  >
         <el-table-column type="selection" width="65">
          ...
          <el-table-column label="账号" align="center" width="">
            <template scope="scope">
              {{scope.row.chnlId}}
            </template>
          </el-table-column>
          ...
          <el-table-column align="center" prop="created_at" label="等级" width="">
            <template scope="scope">
            ...
            <el-table-column align="center"  label="操作" >
                <template scope="scope">
                   ...
                   <el-button size="small" @click="handleCreate"  icon="edit">编辑</el-button>
...
export default {
  data() {
    return {
        ...
        typeOptions:[
          { key: '001', display_name: '管理员' },
          { key: '002', display_name: '高级会员' },
          { key: '003', display_name: '普通会员' }
  ...
  methods: {
    ...
    handleDownload() {
      ...
      require.ensure([], () => {
        ...
        const tHeader = ['账号', '姓名', '性别', '等级', '联系方式'];
